...
def config_parser():
    ...
    parser.add_argument("--n_iters", type=int, default=300000, help="num of iterations")
    parser.add_argument(
    ...
    ########## transibr options ##########
    parser.add_argument("--net", type=str, default="mlp_ibr")
    parser.add_argument("--viewtrans_depth", type=int, default=2)
    ...
    parser.add_argument("--posenc_mode", type=str, default="pre_add")
    parser.add_argument("--rendtrans_depth", type=int, default=2)
    parser.add_argument("--transsep_fine", type=bool, default=False)
    parser.add_argument("--dinofield", action="store_true", help="use dinofield")
    parser.add_argument("--clipfield", action="store_true", help="use clipfield")
    parser.add_argument("--dino_weight", type=float, default=1, help="loss weight for dino")
    parser.add_argument("--dino_type",  type=str, default="v1", help="dino type v1 or v2")
    parser.add_argument("--folder_name",  type=str, default="DiNOFeats", help="DiNOFeats or CLIPFeats")
    parser.add_argument("--dino_dim",  type=int, default=64, help="dimension of the feature vector")
