...
def train(args):
    ...
    while global_step < model.start_step + args.n_iters + 1:
        ...
        for train_data in train_loader:
            ...
            # print("SRC", ray_batch["src_rgbs"].squeeze(0).permute(0, 3, 1, 2).shape)
            ...
            loss, scalars_to_log = criterion(ret["outputs_coarse"], ray_batch, scalars_to_log, global_step, fl_lt_start=200000)
