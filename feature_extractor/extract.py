...
def parse_args():
    ...
    parser.add_argument("--main_folder", default='../data/ibrnet_collected_1', type=str)
    parser.add_argument("--images_name", default='images_2', type=str)
...
def main(args=None):
    ...
    for scene in tqdm.tqdm(scenes):
        ...
        # pk.dump(pca, open(f"pca/ibrnet_dinov1_pca{scene}.pkl","wb"))
